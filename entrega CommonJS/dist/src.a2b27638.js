...
;
module.exports = {
  dataBusinessGetClients: getClients,
  dataBusinessGetAccounts: getAccounts
};
...
function getAccountElement(account) {
  ...
  li.style = StyleBusiness.styleBusiness(account);
...
function getClientElement(client) {
  var allAccounts = DataBusiness.dataBusinessGetAccounts();
  var clientAccounts = [];
  ...
  var ul = AccountBusiness.accountBusiness(clientAccounts);
  node.appendChild(ul);
  return node;
}
...
function printClientsAccounts() {
  var clients = DataBusiness.dataBusinessGetClients();
  var ul = document.createElement("ul");
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var element = ClientBusiness.clientBusiness(client);
...
var PCListBusiness = require("./client-list-business");
